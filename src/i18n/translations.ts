...
export const TRANSLATIONS = {
  ...
  'coding.partition': { en: 'Partition', ar: 'القسم' },
  'coding.partition.medical': { en: 'Medical', ar: 'طبي' },
  'coding.partition.surgical': { en: 'Surgical', ar: 'جراحي' },
  'coding.procedureDetected': { en: 'Procedure detected', ar: 'الإجراء المرصود' },
  'coding.explanation': { en: 'Why this grouping? (explainability trace)', ar: 'لماذا هذا التصنيف؟ (مسار التفسير)' },
